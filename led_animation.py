...
GPIO.setup(7, GPIO.OUT)		# this function makes the given pin as(7) a output pin

while True:
	GPIO.output(7, True)	# this function change the GPIO voltage to +5 volts 
	...
	GPIO.output(7, False)	# this function change the GPIO voltage to 0 volts
